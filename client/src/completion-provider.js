...
const completionProvider = {
    ...
    provideCompletionItems(document, position, token, context) {
        ...
        const keywords = [
            ...
            { label: 'try$', kind: vscode.CompletionItemKind.Keyword, detail: 'Exception handling try block' },
            { label: 'catch$', kind: vscode.CompletionItemKind.Keyword, detail: 'Exception handling catch block' },
            { label: 'finally$', kind: vscode.CompletionItemKind.Keyword, detail: 'Exception handling finally block' },
