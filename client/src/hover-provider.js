...
const hoverProvider = {
    ...
    getKeywordInfo(keyword) {
        const keywordMap = {
            ...
            'foreach$': new vscode.MarkdownString('**For-Each Loop Statement**\n\nUsed to iterate through collections.\n\n```tesseract\nforeach$ item in collection {\n    # code\n}\n```\n\n**Examples:**\n```tesseract\nlet$ numbers := [1, 2, 3];\nforeach$ num in numbers {\n    ::print num;\n}\n```'),
            ...
            'foreach': new vscode.MarkdownString('**For-Each Loop Keyword**\n\nUse with $ suffix: `foreach$`'),
            'break$': new vscode.MarkdownString('**Break Statement**\n\nExits the current loop.\n\n```tesseract\nloop$i := 1 => 10 {\n    if$ i == 5 {\n        break$;\n    }\n    ::print i;  # prints 1, 2, 3, 4\n}\n```'),
            'continue$': new vscode.MarkdownString('**Continue Statement**\n\nSkips to the next iteration of the loop.\n\n```tesseract\nloop$i := 1 => 5 {\n    if$ i == 3 {\n        continue$;\n    }\n    ::print i;  # prints 1, 2, 4, 5\n}\n```'),
            'break': new vscode.MarkdownString('**Break Statement Keyword**\n\nUse with $ suffix: `break$`'),
            'continue': new vscode.MarkdownString('**Continue Statement Keyword**\n\nUse with $ suffix: `continue$`'),
